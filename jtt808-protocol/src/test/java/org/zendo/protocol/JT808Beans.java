package org.zendo.protocol;

import io.github.yezhihao.protostar.util.KeyValuePair;
import io.netty.buffer.Unpooled;
import org.zendo.protocol.basics.JTMessage;
import org.zendo.protocol.commons.Action;
import org.zendo.protocol.commons.Bit;
import org.zendo.protocol.commons.ShapeAction;
import org.zendo.protocol.commons.transform.AttributeKey;
import org.zendo.protocol.commons.transform.attribute.*;
import org.zendo.protocol.commons.transform.parameter.*;
import org.zendo.protocol.commons.transform.passthrough.PeripheralSystem;
import org.zendo.protocol.jsatl12.T1210;
import org.zendo.protocol.jsatl12.T1211;
import org.zendo.protocol.jsatl12.T9208;
import org.zendo.protocol.jsatl12.T9212;
import org.zendo.protocol.t1078.*;
...
public class JT808Beans {
    ...
    public static T8602 T8602(int version) {
        ...
        if (version == 2013) {
            ...
            items.add(new T8602.Rectangle(1, 0, 123123, 112312, 123123, 112312, START_TIME, END_TIME, 200, 30, 40,
                    "测试围栏1"));
            items.add(new T8602.Rectangle(2, 0, 123123, 112312, 123123, 112312, START_TIME, END_TIME, 200, 30, 40,
                    "测试围栏2"));
            items.add(new T8602.Rectangle(3, 0, 123123, 112312, 123123, 112312, START_TIME, END_TIME, 200, 30, 40,
                    "测试围栏3"));
            items.add(new T8602.Rectangle(4, 0, 123123, 112312, 123123, 112312, START_TIME, END_TIME, 200, 30, 40,
                    "测试围栏4"));
            items.add(new T8602.Rectangle(5, 0, 123123, 112312, 123123, 112312, START_TIME, END_TIME, 200, 30, 40,
                    "测试围栏5"));
        }
        bean.setItems(items);
        return bean;
    ...
    public static T1205 T1205() {
        ...
        items.add(new T1205.Item().setChannelNo(1).setStartTime(START_TIME).setEndTime(END_TIME).setWarnBit(0)
                .setMediaType(1).setStreamType(1).setStorageType(1).setSize(1024));
        items.add(new T1205.Item().setChannelNo(2).setStartTime(START_TIME).setEndTime(END_TIME).setWarnBit(0)
                .setMediaType(2).setStreamType(2).setStorageType(2).setSize(2048));
