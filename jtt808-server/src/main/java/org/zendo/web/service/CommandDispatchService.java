...
import org.zendo.web.model.entity.DeviceCommand;
 ...
 *   "responseClass": "org.zendo.protocol.t808.T0001",  // omit for fire-and-forget
...
public class CommandDispatchService implements SmartLifecycle {
    ...
    private static final List<String> ALLOWED_PACKAGES = List.of(
            "org.zendo.protocol.t808.",
            "org.zendo.protocol.t1078.",
            "org.zendo.protocol.jsatl12.",
            "org.zendo.protocol.basics.");
        ...
        try {
            ...
            if (command.isNotify()) {
                ...
                if (responseClassName != null && !responseClassName.isBlank()) {
                    ...
                    respClass = org.zendo.protocol.t808.T0001.class;
                }
